  ...
  const products = await Product.insertMany([
    {
      ...
      sex: 'female',
      age: '3 months',
      description: 'Bella is a friendly and intelligent Beagle dog. She loves playing fetch and is great with kids. She is always ready for an adventure!',
      image: 'bella.jpg',
      quantity: 1,
      price: 1299.99,
    },
    {
      ...
      sex: 'male',
      age: '6 months',
      description: 'Max is a loyal and energetic Beagle dog. He enjoys long walks and learning new tricks. He will be a great companion for an active family!',
      image: 'max.jpg',
      quantity: 1,
      price: 1399.99,
    },
    {
      ...
      sex: 'female',
      age: '6 months',
      description: 'Lucy is a playful and affectionate Beagle dog. She loves cuddling and enjoys being around people. She will bring lots of joy to your home!',
      image: 'lucy.jpg',
      quantity: 1,
      price: 1399.99,
    },
    {
      ...
      sex: 'male',
      age: '9 months',
      description: 'Cooper is a smart and obedient Beagle dog. He excels in obedience training and can learn new commands quickly. He will be a great working companion!',
      image: 'cooper.jpg',
      quantity: 1,
      price: 1499.99,
    },
    {
      ...
      sex: 'female',
      age: '7 months',
      description: 'Daisy is a gentle and protective Beagle dog. She is great with children and has a calm demeanor. She will be a loving and loyal family pet!',
      image: 'daisy.jpg',
      quantity: 1,
      price: 1299.99,
    },
    ...
    },
    {
      ...
      age: '16 weeks',
      image: 'stella.jpg',
      description: 'Stella is an enchanting female Yorkshire Terrier puppy with a silky, multicolored coat that glistens in the sunlight. She is incredibly intelligent and picks up new tricks in no time. Stella loves to sing along to your favorite tunes, and her howling harmonies will have you convinced shes the next rising star of the doggy world!',
      quantity: 1,
      price: 2999.99,
    },
    {
      ...
      age: '12 weeks',
      image: 'sunshine.jpg',
      description: 'Sunshine is a charming female Yorkshire Terrier puppy with a soft, fluffy coat that resembles a cloud. She loves to cuddle up in your lap and shower you with sweet puppy kisses. Sunshine has a hidden talent for doing somersaults when she gets excited, and it is guaranteed to make you smile!',
      quantity: 1,
      price: 2899.99,
    },
    {
      ...
      age: '19 weeks',
      image: 'princess.jpg',
      description: 'Meet Princess, an adorable female Yorkshire Terrier puppy with eyes that sparkle like stars. She has a playful and mischievous nature, always keeping you on your toes. Princess has a unique talent for balancing treats on her nose and catching them in mid-air. Get ready for some entertaining snack time with this little acrobat!',
      quantity: 1,
      price: 2599.99,
    },
    {
      ...
      age: '16 weeks',
      image: 'Chonks.jpg',
      description: 'Chinks is a dashing male Yorkshire Terrier puppy with an irresistible teddy bear face that melts hearts wherever he goes. He is a social butterfly and adores meeting new people and furry friends. Chonks has a remarkable talent for playing hide-and-seek and can find the most clever hiding spots. Get ready for hours of fun and laughter with this little explorer!',
      quantity: 1,
      price: 2799.99,
    },
    {
      ...
      age: '12 weeks',
      image: 'gunther.jpg',
      description: 'Gunther is a charismatic male Yorkshire Terrier puppy with a luxurious, wavy coat that is perfect for snuggling. Gunther loves playing dress-up, and his fashion sense is off the charts. You will have a blast dressing him up in adorable outfits and capturing the most Instagram-worthy moments!',
      quantity: 1,
      price: 2999.99,
    },
    {
